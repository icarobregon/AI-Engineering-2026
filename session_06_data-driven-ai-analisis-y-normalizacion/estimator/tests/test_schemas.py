...
def test_phases_sum_overrides_total_cost() -> None:
    # Validator recomputes total_cost_eur from phases — never raises on mismatch.
    result = EstimationResult(**_valid_result(total_cost_eur=31_000))  # phases sum to 30_000
