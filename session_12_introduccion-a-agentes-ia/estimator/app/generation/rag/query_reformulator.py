...
produces compressed distances and irrelevant hits (the first failure the Session
9 diagnosis identified). This stage distills the transcript into an
:class:`EstimationQuery` and then composes a short, technical, English search
string aligned with the corpus.
