...
async def estimate_all(
    ...
    *,
    ...
    # Search mode + reranking follow the runtime/settings defaults
    # (PUT /api/v1/config/retrieval), so the per-task search benefits from
    # hybrid/rerank without changing this contract.
